...
class APawn;
class AIDPlayerController;

UCLASS()
class IRONDEFIANCE_API UAnimInstanceBase : public UAnimInstance
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (DisplayName = "Tank Pointer"))
	ACharacterBase* m_Tank = nullptr;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"), meta = (DisplayName = "Player Controller Pointer"))
	AIDPlayerController* m_PC = nullptr;
	...
	ECameraMode m_CurrentMode = ECameraMode::DEFAULT_MAX;
};
